 ...
 * retained. The function forwards a minimized, HMAC-authenticated envelope to
 * the administrator-owned HuffSherpa Apps Script staging endpoint. It never
 * sends a Google Ads conversion and it never changes campaign configuration.
 *
 * Activation remains blocked until both environment variables are provisioned:
