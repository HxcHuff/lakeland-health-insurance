...
test('coverage center is a two-lane 2027 plan-review hub wired into get-help', () => {
  ...
  assert.match(COVERAGE_CENTER, /href="\/get-help\/\?intent=medicare&amp;source_page_key=coverage_center&amp;source_cta_key=plan_review_medicare_lane" data-medicare-cta="plan_review_medicare_lane">Request a plan review<\/a>/);
  assert.match(COVERAGE_CENTER, /href="\/get-help\/\?intent=under-65">Request a plan review<\/a>/);
  assert.match(COVERAGE_CENTER, /href="\/get-help\/">Request a plan review<\/a>/);
